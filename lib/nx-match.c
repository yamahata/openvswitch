...
static size_t padded_match_len(size_t match_len, size_t hdr_len)
{
                ...
                ovs_be64 *cookie, ovs_be64 *cookie_mask)
{
    ...
    p = ofpbuf_try_pull(b, padded_match_len(match_len, hdr_len));
    if (!p) {
             ...
             ovs_be64 cookie, ovs_be64 cookie_mask)
{
    ...
    pad_len = padded_match_len(match_len, hdr_len) - match_len;
